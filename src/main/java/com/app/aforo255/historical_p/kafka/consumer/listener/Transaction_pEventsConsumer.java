package com.app.aforo255.historical_p.kafka.consumer.listener;

import org.springframework.beans.factory.annotation.Autowired;
import org.springframework.kafka.annotation.KafkaListener;
import org.springframework.stereotype.Component;

import com.app.aforo255.historical_p.service.Transaction_pEvents;
...
public class Transaction_pEventsConsumer {
	...
	public void onMessage(ConsumerRecord<Integer,String> consumerRecord) throws  JsonProcessingException {
		...
		transaction_pEvents.processTransactionEvent(consumerRecord);
	}
}
